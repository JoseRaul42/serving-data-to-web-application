    ...
    <Sheet.Root>
      ...
      <Sheet.Content side="left">
        <nav class="grid gap-6 text-lg font-medium">
          ...
          <a href="/Bills-Supported" class="text-muted-foreground hover:text-foreground">Bills Supported</a>
          <a href="/Bills-Not-Supported" class="text-muted-foreground hover:text-foreground">Bills Opposed</a>
